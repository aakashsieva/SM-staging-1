...
export async function loginToMatrackDashboard(page, username = 'aakash', password = 'Vj@#!101df2a') {
    ...
    while (retryCount < maxRetries) {
        try {
            ...
            await page.goto('https://www.tracking1.matrack.io/gpstracking/adminnew/view/accessaccount.php', {
            ...
            await page.goto('https://www.tracking1.matrack.io/gpstracking/client/HomeTowneCap/maps/dashboard.php', {
                waitUntil: 'domcontentloaded',
                timeout: 120000
            });
