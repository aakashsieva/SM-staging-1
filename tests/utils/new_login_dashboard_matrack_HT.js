...
export async function loginToMatrackDashboard(page, username = 'aakash', password = 'Vj@#!101df2a') {
    ...
    while (retryCount < maxRetries) {
        try {
            ...
            await page.goto('https://www.matrack-server.com/gpstracking/adminnew/view/accessaccount.php', {
            ...
            await page.goto('https://www.matrack-server.com/gpstracking/client/HomeTowneCap/maps/dashboard.php', {
                waitUntil: 'domcontentloaded',
                timeout: 120000
            });
