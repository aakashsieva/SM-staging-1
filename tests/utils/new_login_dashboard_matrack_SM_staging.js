...
export async function loginToMatrackDashboard(page, username = 'aakash', password = 'Vj@#!101df2a') {
    ...
    while (retryCount < maxRetries) {
        try {
            ...
            await page.goto('https://www.staging.matrack-server.com/gpstracking/adminnew/view/login.php', {
            ...
            await page.goto('https://www.staging.matrack-server.com/gpstracking/client/summitmanagement/maps/dashboard.php', {
                waitUntil: 'domcontentloaded',
